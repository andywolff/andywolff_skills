...
Future<void> recreatePlatforms(String packageDir, String recreatePlatformStr) async {
  ...
  // Delete local analysis_options.yaml if generated by flutter create,
  // to avoid overriding root repository analysis settings.
  final File localAnalysisOptions = File('$packageDir/analysis_options.yaml');
  if (localAnalysisOptions.existsSync()) {
    print('🧹 Deleting generated local analysis_options.yaml to preserve root repository settings...');
    try {
      await localAnalysisOptions.delete();
    } catch (e) {
      stderr.writeln('Warning: Failed to delete local analysis_options.yaml: $e');
    }
  }
}
